...
s32 func_ptr_80170010(Entity* self) {
    ...
    if (PLAYER.ext.player.anim < 0x41 ||
        PLAYER.ext.player.anim > 0x47 ||
        !g_Player.unk46) {
        DestroyEntity(self);
        return;
    }
    ...
    case 0:
        ...
        for (i = 0; i < PrimCount; i++) {
            ...
            prim->drawMode = DRAW_UNK_200 | DRAW_UNK_100 | DRAW_TPAGE2 | DRAW_TPAGE | DRAW_HIDE | DRAW_TRANSP;
            if (params == 0) {
                prim->drawMode = DRAW_UNK_200 | DRAW_UNK_100 | DRAW_UNK_40 | DRAW_TPAGE2 | DRAW_TPAGE | DRAW_HIDE | DRAW_TRANSP;
            }
            prim = prim->next;
        }
    ...
    for (i = 0; i < PrimCount; i++) {
        ...
        case 1:
            ...
            result = func_162000_8017B784(prim,
                x,
                y);
            D_162000_8017CBFC[i].y--;
            if (result < 0) {
