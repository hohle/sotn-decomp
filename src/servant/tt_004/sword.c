...
void func_us_80177480(Entity* self) {
    ...
    case 0:
        ...
        if (!self->params) {
            self->posX.i.hi = *((s32*) &D_us_801786C0[0]) & 0xFFFF;
            self->posY.i.hi = (*((s32*) &D_us_801786C0[0]) >> 16) & 0xFFFF;
        } else {
            self->posX.i.hi = *((s32*) &D_us_801786C0[1]) & 0xFFFF;
            self->posY.i.hi = (*((s32*) &D_us_801786C0[1]) >> 16) & 0xFFFF;
        }
